<?php
include "sesi_admin.php";  // Mengambil sesi login
if (isset($_POST['simpan'])) {
    ...
    $sql_check = "SELECT * FROM tb_operator WHERE nama_operator = '$nama_operator'";
    ...
    $sql_insert = "INSERT INTO tb_operator 
        ...
        VALUES ('$nama_operator', '$nik', '$alamat', '$no_telp', '$no_sio', '$jenis_sio', '$operator', '$kelas_operator', '$fotobaru_ktp', '$fotobaru_sio', '$fotobaru_sim', '$fotobaru_dpn', '$fotobaru_blk', '$fotobaru_opr', '$penempatan_opr', '$tgl_masuk', '$status')";

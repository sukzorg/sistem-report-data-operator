  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Data Batangan Unit</h1>
          </div>
        </div>
...
<!-- Print All -->
<a href="?m=batanganUnit&s=export_pdf&print=all" class="btn btn-success">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Tambah Data Batangan Unit</h5>
      ...
      <div class="modal-body">
        <form action="?m=batanganUnit&s=simpan" method="POST" enctype="multipart/form-data">
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="nama_helper" aria-describedby="nama_helperHelp" placeholder="Masukkan Nama Helper">
    <small id="emailHelp" class="form-text text-muted">Masukkan Nama Helper</small>
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">Foto MOU </label>
    <input type="file" class="form-control" id="exampleInputEmail1" name="foto_mou" aria-describedby="emailHelp" placeholder="Masukkan Foto Mou">
    <small id="emailHelp" class="form-text text-muted">Masukkan Foto Mou</small>
  </div>
  ...
  <center>
    ...
    <label>Cari Batangan Unit</label>
                                 ...
                                 <th>Aksi</th>
                                  ...
                                  <center>
                                      <ul class="pagination justify-content-center">
                                          <li class="page-item">
                                              <a class="page-link" <?php if ($halaman > 1) { echo "href='?m=batanganUnit&s=awal&halaman=$previous'"; } ?>>Previous</a>
                                          </li>
                                          <?php 
                                          // Menampilkan link halaman
                                          for ($x = 1; $x <= $total_halaman; $x++) {
                                              echo "<li class='page-item'><a class='page-link' href='?m=batanganUnit&s=awal&halaman=$x'>$x</a></li>";
                                          }
                                          ?>
                                          <li class="page-item">
                                              <a class="page-link" <?php if ($halaman < $total_halaman) { echo "href='?m=batanganUnit&ss=awal&halaman=$next'"; } ?>>Next</a>
                                          </li>
                                      </ul>
                                  </center>
                                </div>

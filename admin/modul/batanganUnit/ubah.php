  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="exampleInput" name="merek_unit" aria-describedby="merek_unitHelp">
              ...
              <option value="JLG" <?php if($r['merek_unit'] == "Lain lain") echo 'selected'; ?>>Lain lain</option>
            </select>
        ...
        <div class="form-group">
          <label for="exampleInputDate">Nama Helper</label>
          <input type="text" class="form-control" id="exampleInputDate" name="nama_helper" value="<?php echo $r['nama_helper'];?>" aria-describedby="no_unitHelp" placeholder="Masukkan Nama Helper">
          <small id="emailHelp" class="form-text text-muted">Masukan Nama Helper</small>
        </div>

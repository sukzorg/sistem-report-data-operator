...
<html>
  <head>
    ...
    <title>Detail Foto Keterangan Biaya</title>
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Detail Foto Keterangan</h1>
          </div>
        </div>
        ...
        $query_biaya = mysqli_query($koneksi, "SELECT * FROM tb_lain_lain WHERE id_biaya = '$id_biaya'");
        $biaya = mysqli_fetch_assoc($query_biaya);
        ?>


        <!-- Menampilkan Foto Keterangan Biaya Lain Lain -->
        <section class="photo-section">
          <h4>Foto Keterangan Biaya Lain Lain</h4>
          <img src="../images/foto_keterangan/<?php echo $biaya['foto_keterangan']; ?>" class="img-thumbnail" alt="Foto keterangan">
          <!-- Button Download Foto keterangan -->
          <a href="../images/foto_keterangan/<?php echo $biaya['foto_keterangan']; ?>" class="btn btn-success download-btn" download>Download Foto Keterangan Biaya Lain Lain</a>
        </section>

        <!-- Kembali ke halaman sebelumnya -->
        <section class="back-button">
          <a href="?m=biayaLain&s=awal" class="btn btn-primary">Kembali</a>
        </section>
      </div>
    </div>

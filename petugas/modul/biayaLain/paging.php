...
$query_count = "SELECT COUNT(*) as total FROM tb_lain_lain WHERE penempatan = ?";
...
if (isset($_POST['go'])) {
    ...
    $query_data = "SELECT * FROM tb_lain_lain WHERE penempatan = ? 
    ...
    $query_data = "SELECT * FROM tb_lain_lain WHERE penempatan = ? LIMIT ?, ?";
    $stmt_data = mysqli_prepare($koneksi, $query_data);
...
// Menampilkan data
$nomor = $halaman_awal + 1; // Inisialisasi nomor urut

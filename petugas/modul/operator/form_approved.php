...
<html>
  ...
  <body>
    ...
    <div class="row">
    	...
    	<form action="?m=operator&s=form_approved" method="POST" enctype="multipart/form-data">
      ...
      <input type="hidden" name="id_operator" value="<?php echo $r['id_operator'];?>" >
        ...
        <div class ="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" name="nama_operator" value="<?php echo $r['nama_operator'];?>" aria-describedby="namalHelp" placeholder="Masukkan Nama Operator" disabled>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" name="nik" value="<?php echo $r['nik'];?>" aria-describedby="niklHelp" placeholder="Masukkan NIK (Nomer Induk KTP)" disabled>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" name="no_sio" value="<?php echo $r['no_sio'];?>" aria-describedby="niklHelp" placeholder="Masukkan no SIO" disabled>
          <small id="emailHelp" class="form-text text-muted">Masukkan no SIO</small>
        </div>
        
        <div class="form-group">
            <label for="exampleInputoperator">Operator</label>
            <select class="form-control" id="exampleInput" name="operator" aria-describedby="operatorHelp" disabled>
        ...
        <div class="form-group">
          ...
          <select class="form-control" id="exampleInput" name="kelas_operator" aria-describedby="kelas_operatorHelp" disabled>
